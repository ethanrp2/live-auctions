...
Working examples for quick prototyping and validation:
- `scripts/basta_client.py` - Reference client covering Management + Client API calls
- `scripts/websocket_example.py` - graphql-ws subscription example against `wss://client.api.basta.app/query`
