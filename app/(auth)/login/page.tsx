    ...
    <div className="rounded-lg border border-neutral-200 bg-white p-8 shadow-sm">
      ...
      <div className="space-y-3">
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-md border border-neutral-300 px-4 py-2 text-sm font-medium text-neutral-700 hover:bg-neutral-50"
        >
          <GoogleIcon />
          Google
        </button>
